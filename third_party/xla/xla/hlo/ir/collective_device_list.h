...
class IotaReplicaGroupList {
 public:
  ...
  bool operator==(const IotaReplicaGroupList& other) const {
    return iota_tile_assignment_ == other.iota_tile_assignment_ &&
           num_replica_groups_ == other.num_replica_groups_ &&
           num_devices_per_group_ == other.num_devices_per_group_;
  }
